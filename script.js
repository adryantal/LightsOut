...
function mas_hatter(azon){ //a bemeneti paraméter az article div id-ja lesz (azon)
   ...
   if ($("article div")[azon].style.backgroundColor === "yellow") {        //ha eddig sárga volt, legyen zöld (kattintásra)
        ...
        z = z + 1;        //növelje 1-el a zöldek számát
        if (z === 25) {    //ha a zöldek száma elérte a 25-öt, kihirdeti a győzelmet
        ...
        z = z-1;        //csökkentse 1-el a zöldek számát   
...
function feladom() {
    ...
    alert(z + " db zöld hátterű négyzet van.");
    init();
}
...
//indexkivalaszt tömb elemei a sárgákhoz tartoznak
